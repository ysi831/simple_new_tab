      ...
      <div class="modal settings-modal">
        ...
        <div class="modal-card">
          ...
          <section class="modal-card-body">
            ...
            <h2>このアプリについて</h2>
            <p><b>Simple New Tab</b>は、新しいタブページを独自のブックマークリストに置き換えるシンプルなChrome拡張です。</p>
            <br>
            <p>3カラムでのブックマークの登録、区切り線でのグルーピング、ドラッグドロップによる入れ替えができます。</p>
            <p>Chromeのブックマークとは連携しないため、独自のブックマークを自分で登録して使うことができます。</p>
            <p>登録後、右上の錠前のチェックを入れると余計なボタンが表示されなくなります。</p>
            <p>アイコンは自動で取得されます。</p>
            <br>
